...
module riscv_multicyc
	...
	// ASIC integration fix: declarations are collected before first use so
	// Icarus Verilog, Yosys and Verilator elaborate this upstream RTL equally.
	localparam [6:0] OP_LUI=7'b0110111, OP_AUIPC=7'b0010111;
	localparam [6:0] OP_JAL=7'b1101111, OP_JALR=7'b1100111;
	localparam [6:0] OP_BR=7'b1100011, OP_LOAD=7'b0000011;
	localparam [6:0] OP_STORE=7'b0100011, OP_R_I=7'b0010011;
	localparam [6:0] OP_R=7'b0110011, OP_FENCE=7'b0001111;
	localparam [6:0] OP_PRIV=7'b1110011, OP_AMO=7'b0101111;
	localparam [7:0] IF=8'd10, ID_RF=8'd20, EX=8'd30, MEM=8'd40;
	localparam [7:0] EXU=8'd50, MEMU=8'd60, WB=8'd70;
	localparam [7:0] INTERRUPT=8'd100, EXCEPTION=8'd110;
	localparam [7:0] MRET=8'd120, SRET=8'd130, BAD=8'd255;
	`ifdef RV32M
	localparam [7:0] RV32M_WAIT=8'd80;
	`endif
	`ifdef RV32A
	localparam [7:0] RV32A_MEM1=8'd81, RV32A_WTEMP=8'd82, RV32A_MEM2=8'd83;
	`endif
	(*mark_debug = "true"*) reg [31:0] instruction;
	reg [31:0] newpc, ALUOut, ALUOut2, ALUIn1, ALUIn2;
	reg [31:0] mar, mdr, mem_addr, memwrite_data, imm;
	reg [31:0] storebyte, storehalf;
	reg [7:0] phase, phase_n;
	wire [6:0] op = instruction[6:0];
	wire [31:0] memread_data = {spo[7:0],spo[15:8],spo[23:16],spo[31:24]};
	wire [31:0] new_instr = memread_data;
	wire [31:0] loadbyte, loadhalf;
	wire unaligned = 1'b0;
	`ifdef RV32M
	reg [31:0] RV32MOut;
	`endif
	`ifdef IRQ_EN
	wire [31:0] mtvec_in, mepc_in, sepc_in, csr_spo;
	wire [4:0] csrimm = instruction[19:15];
	reg [31:0] csrreg = 0;
	`endif
...
`ifdef IRQ_EN
	...
	wire [11:0]csr_a = instruction[31:20];
